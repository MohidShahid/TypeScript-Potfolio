        ...
        <AnimatePresence mode="wait">
          ...
          {tabVal === 1 && (
            ...
            >
              ...
              <div className="w-full bg-white/90 dark:bg-[#141416] border border-gray-200/70 dark:border-gray-800 rounded-2xl p-6 md:p-8 shadow-md hover:shadow-xl transition-all duration-300">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 my-6">
                  <div className="p-3.5 rounded-xl bg-[#0808080a] dark:bg-[#1a1a1e] border border-black/5 dark:border-white/5 flex flex-col justify-between">
                ...
                <div className="bg-[#FFE9D9]/40 dark:bg-[#FFB646]/10 border-l-4 border-[#FF9330] p-4 rounded-r-xl my-4">
          ...
          {tabVal === 2 && (
            <motion.div
              ...
              className="flex flex-col gap-6 w-full"
            >
              <h2 className="text-3xl font-bold SyneClass mb-6 text-gray-900 dark:text-white">
                Skills
              </h2>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
                {[
                  ...
                  <motion.div
                    ...
                    className="flex flex-col items-center bg-[#0808080a] dark:bg-[#141416] border border-transparent dark:border-gray-800 p-4 rounded-lg hover:shadow-md transition-shadow cursor-default"
                  >
                    <img
                      src={skill.logo}
                      alt={skill.name}
